    ...
    <main className="min-h-screen bg-[#0f172a] text-white flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      >
        <div className="mb-8 flex flex-col items-center">
          <div className="w-20 h-20 bg-gradient-to-br from-purple-500 to-blue-600 rounded-2xl flex items-center justify-center shadow-2xl shadow-blue-500/20 mb-4 rotate-3 hover:rotate-0 transition-transform">
            <Shield size={40} className="text-white" />
          </div>
          <h1 className="text-5xl font-black bg-clip-text text-transparent bg-gradient-to-r from-white to-gray-400 tracking-tighter mb-2">
            UNDERCOVER
          </h1>
          ...
          <div className="space-y-4">
            <div className="relative">
              <input
                ...
                className="w-full bg-white/5 border border-white/10 rounded-2xl py-4 px-6 focus:outline-none focus:border-purple-500/50 transition-colors text-lg"
              />
            </div>
            ...
            <div className="space-y-3">
              <button
                ...
                className="w-full bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-500 hover:to-blue-500 py-4 rounded-2xl font-bold text-lg flex items-center justify-center gap-2 shadow-xl shadow-blue-500/10 active:scale-95 transition-all disabled:opacity-30 disabled:scale-100"
              >
                <Plus size={24} />
                Create New Room
              </button>
              ...
              <div className="flex gap-3">
                <input
                  ...
                  maxLength={6}
                  className="flex-1 bg-white/5 border border-white/10 rounded-2xl py-4 px-6 focus:outline-none focus:border-blue-500/50 transition-colors text-lg text-center font-mono tracking-widest"
                />
                <button
                  onClick={handleJoin}
                  disabled={!name || !roomCode || !isConnected}
                  className="bg-white/10 hover:bg-white/20 p-4 rounded-2xl transition-all active:scale-95 disabled:opacity-30"
                >
                  <Search size={24} />
                </button>
              </div>
